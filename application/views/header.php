        ...
        <ul class="menu_bg">
    	  ...
    	  <?
				 if(($page != 'view') && ($page != 'searchnew')) 
				{
					...
					if($page == 'commercial')
					$imageslist = array('slide14.jpg','slide7.jpg','slide1.jpg','slide15.jpg','slide12.jpg','slide4.jpg');
					if($page == 'business')
					$imageslist = array('slide18.jpg','slide20.jpg','slide15.jpg','slide10.jpg','slide17.jpg');
				?>
				<div id="slides">
					<?
