	...
	<div class="wrapper">
		    <? if($page!= 'admin' && $page!= 'login') { ?>
				...
				{?>
					...
					<ul class="menu_bg">
						<?
						if(($slidepage!='business') && ($slidepage!='sell_your_business')) { ?><li class="residential"><a href="<?php echo base_url('residential'); ?>">Residential</a></li>
				...
				{
					$imageslist = array('slide1.jpg','slide2.jpg','slide3.jpg','slide4.jpg','slide5.jpg','slide7.jpg','slide8.jpg','slide10.jpg','slide6.jpg');
					if($page == 'residential')
					$imageslist = array('slide2.jpg','slide16.jpg','slide19.jpg','slide3.jpg','slide6.jpg','slide21.jpg');
					if($page == 'commercial')
					$imageslist = array('slide14.jpg','slide7.jpg','slide22.jpg','slide1.jpg','slide15.jpg','slide4.jpg');
					if(($page == 'business') || ($page == 'sell_your_business'))
